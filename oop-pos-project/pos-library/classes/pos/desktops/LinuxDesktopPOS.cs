...
{
    public class LinuxDesktopPOS : DesktopPOS
    {
        public LinuxDesktopPOS(string machineName, string ipAddress, string version, string location) : base(machineName, ipAddress, version, location)
        {
            SetPOSType(Constants.POS_TYPE_LINUX_DESKTOP);
        }
