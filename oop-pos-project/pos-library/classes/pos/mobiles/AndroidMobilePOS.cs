...
{
    public class AndroidMobilePOS : MobilePOS
    {
        public AndroidMobilePOS(string machineName, string ipAddress, string version, string phoneNumber) : base(machineName, ipAddress, version, phoneNumber)
        {
            SetPOSType(Constants.POS_TYPE_ANDROID_MOBILE);
        }
